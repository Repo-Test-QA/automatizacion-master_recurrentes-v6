...
public class AddInactiveFrequentList {
    ...
    public void she_should_see_the_screen_Your_list_is_already_created() throws Throwable {
        ...
        String txtActualTabInactive = tabInactive.getText();
        String txtExpectedTabInactive = "Inactiva";
        Assert.assertEquals(txtExpectedTabInactive, txtActualTabInactive);
        ...
        String txtExpectedTitleListInactive = "Test AT 82";
